...
(function () {
  ...
  const DICT = {
    en: {
      ...
      "landing.radar.title": "Civic Accountability Radar",
      ...
      "radar.title": "Civic Accountability Radar",
      ...
      "radar.legend.good": "Well sited (≤8 km)",
      "radar.legend.review": "Review (8–25 km)",
      "radar.legend.flag": "Misallocation risk (>25 km)",
      "radar.legend.optimal": "ML-optimal site",
      "radar.legend.note": "Dashed line = distance from the build to the model's nearest optimal site.",
    ...
    bg: {
      ...
      "landing.radar.title": "Радар за гражданска отчетност",
      ...
      "radar.title": "Радар за гражданска отчетност",
      ...
      "radar.legend.good": "Добре разположен (≤8 км)",
      "radar.legend.review": "За преглед (8–25 км)",
      "radar.legend.flag": "Риск от лошо разпределение (>25 км)",
      "radar.legend.optimal": "Оптимална локация (ML)",
      "radar.legend.note": "Прекъсната линия = разстояние от строежа до най-близката оптимална локация на модела.",
